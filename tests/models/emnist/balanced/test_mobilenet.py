...
from torchfl.models.core.emnist.balanced.mobilenet import MobileNetV2
from torchfl.models.core.emnist.balanced.mobilenet import MobileNetV3Large
from torchfl.models.core.emnist.balanced.mobilenet import MobileNetV3Small
...
def test_mobilenetv2_3_channels_output_shape(three_channel_loader):
    """Testing the MobileNet output for a 3-channel EMNIST image.
