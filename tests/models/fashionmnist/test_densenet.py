...
def test_densenet121_3_channels_output_shape(fashionmnist_3_channel_loader):
...
def test_densenet161_3_channels_output_shape(fashionmnist_3_channel_loader):
    """Testing the AlexNet output for a 3-channel FashionMNIST image.
...
def test_densenet169_3_channels_output_shape(fashionmnist_3_channel_loader):
    """Testing the AlexNet output for a 3-channel FashionMNIST image.
...
def test_densenet201_3_channels_output_shape(fashionmnist_3_channel_loader):
    """Testing the AlexNet output for a 3-channel FashionMNIST image.
