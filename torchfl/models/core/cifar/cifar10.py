...
"""Contains the model implementations for CIFAR10 dataset."""
...
class DenseNet(BaseDensenet):
    def __init__(self) -> None:
        """Constructor"""
        super(DenseNet, self).__init__(num_classes=10, num_channels=3)


class GoogleNet(BaseGoogleNet):
    def __init__(self) -> None:
        """Constructor"""
        super(GoogleNet, self).__init__(num_classes=10, num_channels=3)
