...
"""Contains the quantized MobileNet model implementations for EMNIST (by class) dataset.
...
import torchfl.models.sota.quantized.mobilenet as BaseMobileNet
...
class MobileNetV2(BaseMobileNet.MobileNetV2):
    def __init__(self, feature_extract=False) -> None:
        ...
        super(MobileNetV2, self).__init__(
            feature_extract=feature_extract, num_classes=62, act_fn_name="relu"
        )
