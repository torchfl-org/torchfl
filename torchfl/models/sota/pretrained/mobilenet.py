...
class MobileNetV2(models.mobilenet.mobilenet_v2(pretrained=True, progress=True)):
    def __init__(
...
class MobileNetV3Small(
    models.mobilenet.mobilenet_v3_small(pretrained=True, progress=True)
):
    def __init__(
        self, feature_extract=True, num_classes=10, act_fn_name="relu", **kwargs
    ) -> None:
...
class MobileNetV3Large(
    models.mobilenet.mobilenet_v3_large(pretrained=True, progress=True)
):
    def __init__(
        self, feature_extract=True, num_classes=10, act_fn_name="relu", **kwargs
    ) -> None:
